...
struct R: Rswift.Validatable {
  ...
  struct nib {
    ...
    /// Nib `RecentValueTableViewCell`.
    static let recentValueTableViewCell = _R.nib._RecentValueTableViewCell()
    ...
    #if os(iOS) || os(tvOS)
    /// `UINib(name: "RecentValueTableViewCell", in: bundle)`
    @available(*, deprecated, message: "Use UINib(resource: R.nib.recentValueTableViewCell) instead")
    static func recentValueTableViewCell(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.recentValueTableViewCell)
    }
    #endif
    ...
    static func recentValueTableViewCell(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> RecentValueTableViewCell? {
      return R.nib.recentValueTableViewCell.instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? RecentValueTableViewCell
    }
...
struct _R: Rswift.Validatable {
  ...
  struct nib: Rswift.Validatable {
    ...
    struct _RecentValueTableViewCell: Rswift.NibResourceType {
      let bundle = R.hostingBundle
      let name = "RecentValueTableViewCell"

      func firstView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> RecentValueTableViewCell? {
        return instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? RecentValueTableViewCell
      }
    ...
    struct _S5BloodPressureChartCollectionViewCell: Rswift.NibResourceType, Rswift.Validatable {
      ...
      static func validate() throws {
        ...
        if #available(iOS 11.0, tvOS 11.0, *) {
          ...
          if UIKit.UIColor(named: "title", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Color named 'title' is used in nib 'S5BloodPressureChartCollectionViewCell', but couldn't be loaded.") }
        }
      }
