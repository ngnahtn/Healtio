//
//  SKCustomSwitch.swift
//  1SKConnect
//
//  Created by Be More on 26/01/2022.
//

import UIKit

@IBDesignable
public class SKCustomSwitch: UIControl {
    ...
    public var thumbView = SKCustomThumbView(frame: CGRect.zero)
